/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e5cabfaa5a44ba2fd772cec968dad585)
// Runtime types generated with workerd@1.20260811.1 2026-08-01 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	DEV_MODE: string;
	DEFAULT_CHANNEL: string;
	LOYALTY: DurableObjectNamespace<import("./src/index").LoyaltyRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LoyaltyRoom";
	}
